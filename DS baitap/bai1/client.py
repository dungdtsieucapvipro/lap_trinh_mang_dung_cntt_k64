...
def tcp_sequential_client():
    ...
    print(f"Các số nguyên tố trong khoảng từ {a} đến {b} là: {data}")
    client_socket.close()
...
def udp_sequential_client():
    ...
    a = int(input("Nhập số nguyên a: "))
    b = int(input("Nhập số nguyên b: "))
    client_socket.sendto(f"{a} {b}".encode(), ("127.0.0.1", 12348))
    
    data, _ = client_socket.recvfrom(1024)
    print(f"Các số nguyên tố trong khoảng từ {a} đến {b} là: {data.decode()}")
    client_socket.close()
...
def udp_parallel_client():
    ...
    a = int(input("Nhập số nguyên a: "))
    b = int(input("Nhập số nguyên b: "))
    client_socket.sendto(f"{a} {b}".encode(), ("127.0.0.1", 12349))
